	...
	print_index=function(){//arr==傳值內容  x==分類
		...
		out+="            <p><b>我們傳授給您「終生有效」的學習方法！</b></p>";
		out+="            <p><b>讓您在最短時間做好課業，</b></p>";
		out+="            <p><b>讓您擁有更多時間，盡情去享受青春！</b></p>";
		...
		out+="			<p>榜首贏家-國中雲端學院</p>";
		out+="			<p>版權所有  All Rights Reserved.</p>";
		out+="		  </div> ";
		out+="	  </div> ";
		return out;
	}
	print_menu=function(){//arr==傳值內容  x==分類
		...
		out+="			</div>";
		out+="			<div class='centerwarp1_box02 tcenter'>";
		//out+="				<font color='#af571e'><b>NEW  2017.06.16 - </b></font>";
		out+="				<font color='#020202'><b>親愛的同學們，您準備讓夢想起飛了嗎？</b></font>";
		out+="            </div>";
		out+="            <div class='centerwarp1_box03 tcenter'>";
	//	out+="				<font color='#af571e'><b>NEW  2017.06.14 - </b></font>";
		out+="				<font color='#020202'><b>讓我們與您一同實現夢想！</b></font>";
		out+="            </div>";
